...
def calcular_valor_verdade(grafo, sujeito, objeto):
    print(f"DEBUG: Verificando sujeito: {sujeito}, objeto: {objeto}")
...
def verificar_noticia_completa(sentenca):
    ...
    print(f"DEBUG: Triplas extraídas: {triplas}")
    if not triplas:
